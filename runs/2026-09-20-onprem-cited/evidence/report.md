# Evidence pack — underwriter-sample v0.3.0 — run 2026-09-20-onprem-cited
...
- judge `readability` — mean 0.953 (0–1), reported not gated — *Art 14(4)(a), (c), (d):* A model's opinion on whether the briefing is intelligible, actionable and overridable, citing the passage it applied. Reported next to the checks, never used to pass or fail.
