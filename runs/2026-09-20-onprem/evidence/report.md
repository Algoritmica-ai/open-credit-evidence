...
Assistant under test: `nvidia/nemotron-3.5-lightning` at `http://10.130.232.20:8000/v1` (on-prem). 20 items × 3 repeat(s) = 60 briefings. Judge: `nvidia/nemotron-3-ultra-550b-a55b` (cloud), readability only.
...
- `readability` — mean 0.967 (0–1), reported not gated; 60 judge calls, all auditable
...
- Engine `credit-evidence-engine` 0.1.0.dev0, commit `66ebfb8`. Started 2026-09-20T09:34:13+00:00, finished 2026-09-20T09:34:13+00:00.
