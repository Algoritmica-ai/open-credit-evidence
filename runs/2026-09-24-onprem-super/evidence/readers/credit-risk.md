# Model risk report — underwriter-sample v0.5.0 — run 2026-09-24-onprem-super
...
Judge `readability` (`nemotron-3-super`): mean 0.994 on 0–1 over 60 briefings; every citation was a passage it was given in 60/60. A model's opinion; reported, never used to pass or fail.
...
- Engine `credit-evidence-engine` 0.1.0.dev0, commit `3a7b19b`; pack items sha256 `79ecdc7a23fa…`.
