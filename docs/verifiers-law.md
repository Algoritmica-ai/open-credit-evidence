...
| Say a limit was breached only when it was | "Exceeds 40%" and "33.2%" two lines apart each pass alone | `claim_consistency` — the claim against the briefing's own figure | instant |
