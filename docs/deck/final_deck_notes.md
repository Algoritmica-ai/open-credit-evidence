# Final deck — speaker notes

Ten minutes. Slides 6, 7 and 9 carry mockup numbers marked with a yellow tag;
they are replaced by the numbers from the committed run and the judge study.
Slides 2, 4 and 8 use real numbers from the first live runs.
...
- Every yellow "mockup" tag removed before the presentation.
