...
## Priority IDs for OpenCredit Evidence

| ID | Why it matters to OpenCredit |
|---|---|
...
shared FINOS mapping is maintained in [`eu-ai-act-finos-controls.md`](../../eu-ai-act-finos-controls.md)
rather than duplicated here.

## Non-claims

An OpenCredit evidence report can demonstrate that particular facts were checked, a summary passed
